...
export const assessments: Assessment[] = [
    {
        id: '1', name: 'Midterm Exam', courseName: 'Organic Chemistry', courseColor: '#06B6D4', dueDate: 'Mar 7', countdown: '7d 0h', coveragePercent: 78,
        topics: [
    ...
    {
        id: '2', name: 'Quiz 5: Fiscal Policy', courseName: 'Macroeconomics', courseColor: '#F59E0B', dueDate: 'Mar 2', countdown: '2d 8h', coveragePercent: 65,
        topics: [
